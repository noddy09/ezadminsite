...
class Command(DbInspect):
    ...
    def handle_lines(self, connection):
    ...
    def handle(self, **options):
        ...
        for connection in connections.all():
            try:
                with open(f"core/model/{connection.alias}.py", "w", encoding="utf-8") as output_file:
                    for line in self.handle_lines(connection):
            ...
            try:
                with open(f"core/admin/{connection.alias}.py", "w", encoding="utf-8") as output_file:
                    output_file.write("""
