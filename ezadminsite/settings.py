"""
Django settings for ezadminsite project.
...
def gfe(key, default=None):
    try:
        ...
        if not default:
            raise Exception(f"Environment variable expected: {key}")
        return default
...
WSGI_APPLICATION = 'ezadminsite.wsgi.application'
